...
4. `/postman-collection-generator` → genera colecciones de Postman v9.13.2 para validación de API (**obligatorio**)
5. `/automation-flow-proposer` → propone automatización E2E con **Serenity BDD** (**opcional**)
...
| `<feature>.postman_collection.json` | postman-collection-generator | Siempre |
